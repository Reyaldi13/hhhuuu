...
// Sample inventory data (Barang dengan harga sesuai pasaran)
const inventory = [
...
// Endpoint untuk mendapatkan data inventaris
app.get('/inventory', (req, res) => {
  res.json(inventory);
});

// Endpoint untuk mengurutkan inventaris
app.get('/inventory/sort', (req, res) => {
